...
import cn.coderoom.generator.frontend.engine.SimpleTemplateEngine;
import cn.coderoom.generator.frontend.engine.base.CodeTemplateEngine;
import cn.coderoom.generator.frontend.engine.config.ContextConfig;
import cn.coderoom.generator.frontend.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doGunsGeneration() {
        ...
        codeTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        codeTemplateEngine.setSqlConfig(sqlConfig);
        codeTemplateEngine.setTableInfo(tableInfo);
        codeTemplateEngine.start();
    }
