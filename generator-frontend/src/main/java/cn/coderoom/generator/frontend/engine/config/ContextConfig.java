...
public class ContextConfig {
    ...
    private String templatePrefixPath = "template/base";
    ...
    private String proPackage = "cn.coderoom.admin";
    private String coreBasePackage = "cn.coderoom.core";
    private String modelPackageName = "cn.coderoom.modular.system.model";        //model的包名
    private String modelMapperPackageName = "cn.coderoom.modular.system.dao";    //model的dao
