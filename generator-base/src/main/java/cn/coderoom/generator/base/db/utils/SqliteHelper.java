...
public class SqliteHelper {
	...
	private static final Logger _LOG = LoggerFactory.getLogger(SqliteHelper.class);
	...
	public static String executeQuerySql(String sql) throws Exception {
	...
	public static List<String> executeQueryListSql(String sql) throws Exception {
	...
	public static int executeUpdateSql(String sql) throws Exception {
	...
	public static String findConnectorLibPath(String dbType) {
		DbTypeEnum type = DbTypeEnum.valueOf(dbType);
