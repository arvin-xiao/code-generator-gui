...
public class GeneratorConfigController extends BaseFXController {
                ...
                protected void updateItem(Object item, boolean empty) {
                    ...
                    if (item == null || empty) {
                        ...
                        btn1.setOnAction(event -> {
                            try {
                                // 应用配置
                                GeneratorConfig generatorConfig = ConfigDao.loadGeneratorConfig(item.toString());
                        ...
                        btn2.setOnAction(event -> {
                            try {
                                ...
                                SqliteHelper.deleteGeneratorConfig(item.toString());
                                refreshTableView();
                            } catch (Exception e) {
                                AlertUtil.showErrorAlert(e.getMessage());
                            }
    ...
    public void refreshTableView() {
        try {
            List<GeneratorConfig> configs = ConfigDao.loadGeneratorConfigs();
